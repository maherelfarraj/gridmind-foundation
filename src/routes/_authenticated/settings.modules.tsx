  ...
  head: () => ({
    meta: [
      { title: "Module access — GridMind EPC" },
      {
        name: "description",
        content:
          "Read-only view of the modules enabled for your GridMind EPC tenant.",
      },
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          These are the GridMind EPC modules enabled for your tenant. Only a
          platform super admin can change them — contact support to request an
          adjustment.
        </p>
      </div>
      {activeCompanyId ? (
