// P-112 — Approval inbox server functions (thin wrapper module).
// Helpers live in approvals.inbox.server.ts so serverfn splitting can't drop them.
