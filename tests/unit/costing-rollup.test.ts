...
const base: CostingInput = {
  ...
  commitments: [
    { id: "po1", kind: "purchase_order", reference: "PO-1", counterparty: "V", status: "issued", amount: 400_000, currency_code: "USD" },
    { id: "po2", kind: "purchase_order", reference: "PO-2", counterparty: "V", status: "cancelled", amount: 250_000, currency_code: "USD" },
    { id: "po3", kind: "purchase_order", reference: "PO-3", counterparty: "V", status: "draft", amount: 90_000, currency_code: "USD" },
    { id: "sc1", kind: "subcontract", reference: "SC-1", counterparty: "S", status: "active", amount: 150_000, currency_code: "USD" },
    { id: "sc2", kind: "subcontract", reference: "SC-2", counterparty: "S", status: "terminated", amount: 70_000, currency_code: "USD" },
    { id: "co1", kind: "change_order", reference: "CO-1", counterparty: null, status: "approved", amount: 50_000, currency_code: "USD" },
    { id: "co2", kind: "change_order", reference: "CO-2", counterparty: null, status: "incorporated", amount: 200_000, currency_code: "USD" },
    { id: "co3", kind: "change_order", reference: "CO-3", counterparty: null, status: "rejected", amount: 30_000, currency_code: "USD" },
  ],
  invoices: [
    { id: "i1", direction: "payable", status: "paid", amount: 120_000, currency_code: "USD" },
    { id: "i2", direction: "payable", status: "partially_paid", amount: 80_000, currency_code: "USD" },
  ...
  payments: [
    { id: "p1", direction: "payable", record_status: "recorded", amount: 120_000, currency_code: "USD" },
    { id: "p2", direction: "payable", record_status: "recorded", amount: 30_000, currency_code: "USD" },
    { id: "p3", direction: "payable", record_status: "voided", amount: 50_000, currency_code: "USD" },
    { id: "p4", direction: "receivable", record_status: "recorded", amount: 700_000, currency_code: "USD" },
  ],
  accruals: [
...
describe("computeCostingRollup", () => {
  ...
  it("splits roll-ups by currency", () => {
    const rows = computeCostingRollup({
      ...
      budgets: [
        ...base.budgets,
        { original_amount: 100_000, approved_changes: 0, current_amount: 100_000, currency_code: "EUR" },
      ],
    });
